    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                @elseif($role == 'anggota')
                    <li class="nav-item">
                        <a href="{{ route('anggota.dashboard') }}" class="nav-link {{ $currentRoute == 'anggota.dashboard' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                ...
                @elseif($role == 'departemen')
                    <li class="nav-item">
                        <a href="{{ route('departemen.dashboard') }}" class="nav-link {{ $currentRoute == 'departemen.dashboard' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                ...
                @elseif($role == 'keuangan')
                    <li class="nav-item">
                        <a href="{{ route('keuangan.dashboard') }}" class="nav-link {{ $currentRoute == 'keuangan.dashboard' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
